...
local colors = {
	...
	-- Selection and search (solid colors - use blend for transparency)
	selection = "#3d2a1a", -- Selection background (dark orange tint)
	search = "#3d3517", -- Search match background (dark gold tint)
	visual = "#4d2f12", -- Visual mode selection (darker orange tint)
...
hl("GitSignsAddLn", { bg = "#132a1a" })
hl("GitSignsChangeLn", { bg = "#2a2510" })
hl("GitSignsDeleteLn", { bg = "#2a1212" })

-- Diff
hl("DiffAdd", { fg = colors.none, bg = "#132a1a" })
hl("DiffChange", { fg = colors.none, bg = "#2a2510" })
hl("DiffDelete", { fg = colors.git_delete, bg = "#2a1212" })
hl("DiffText", { fg = colors.none, bg = "#3d3517" })
